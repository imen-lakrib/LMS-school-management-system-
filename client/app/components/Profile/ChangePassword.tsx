...
const ChangePassword: FC<Props> = ({ user }) => {
  ...
  return (
    <div className="w-full pl-7 px-2 800px:px-5 800px:pl-0 text-left">
      ...
      <div className="w-full">
        ...
        >
          ...
          <div className="w-[100%] 800px:w-[60%] mt-5">
            ...
            <input
              type="submit"
              className={`w-[95%] h-[40px] border border-[#37a39a] text-center text-white rounded-[3px] mt-8 cursor-pointer`}
              required
              value="Update"
            />
          </div>
